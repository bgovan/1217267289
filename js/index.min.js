! function t(e, i, r) {
    ...
    206: [function(t, e, i) {
        ...
        function n(t, e) { //loadImages
            return Promise.all(t.map(function(t, i) {
                return r(t, i, e)
            }))
        }

        function s(t, e) { //ImageLoader
    ...
    207: [function(t, e, i) {
        ...
        function n() { //loadTextures
            (0, y["default"])([{
                ...
                name: "textureWindowFrame",
                src: "img/frame.png"
            }]).then(function(t) {
                textureWindowFrame = t.textureWindowFrame.img, O = t.textureRainFg.img, j = t.textureRainBg.img, A = t.textureFalloutFg.img, M = t.textureFalloutBg.img, k = t.textureStormLightningFg.img, R = t.textureStormLightningBg.img, C = t.textureSunFg.img, D = t.textureSunBg.img, F = t.textureDrizzleFg.img, E = t.textureDrizzleBg.img, I = t.dropColor.img, N = t.dropAlpha.img, s()
            })
        }
        ...
        function s() { //init
            ...
            }), textureFrame = (0, $["default"])(Y.width, Y.height), textureFrameCtx = textureFrame.getContext("2d"), z = (0, $["default"])(Y.width, Y.height), L = z.getContext("2d"), B = (0, $["default"])(U.width, U.height), X = B.getContext("2d"), p(textureWindowFrame, O, j), q = new m["default"](W, G.canvas, textureFrame, z, B, null, {
                brightness: 1.04,
                alphaMultiply: 6,
                alphaSubtract: 3
            }), o()
        ...
        function o() { //setupEvents
            a(), u(), l()
        }

        function a() { //setupParallax
            ...
            function n(n) {
                ...
                return new Promise(function(a, l) {
                    w["default"].to(s, o, {
                        ...
                        ease: Quint.easeOut,
                        onUpdate: function() {
                            p(textureWindowFrame, e, t), p(textureWindowFrame, r, i, s.v), q.updateTextures()
                        },
                        onComplete: function() {
                            a()
                        }
        ...
        function p(frame, t, e) {
            var i = arguments.length <= 3 || void 0 === arguments[3] ? 1 : arguments[3];
            textureFrameCtx.globalAlpha = i, textureFrameCtx.drawImage(frame, 0, 0,Y.width, Y.height), L.globalAlpha = i, L.drawImage(t, 0, 0, Y.width, Y.height), X.globalAlpha = i, X.drawImage(e, 0, 0, U.width, U.height)
        }
        t("core-js");
